...
export const AppSidebar = ({ role, items, user }: AppSidebarProps) => {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 border-r border-border bg-card">
      ...
      <div className="border-t border-dashed border-border p-4 space-y-3">
        {user && (
        ...
        <button
          onClick={signOut}
          className="flex items-center gap-3 px-3 py-2 w-full rounded-lg text-sm text-foreground/70 hover:bg-muted hover:text-foreground transition-colors"
        >
